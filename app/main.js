...
$(function() {
  ...
  function addParticipantsMessage (data) {
    ...
    if (!data.userJoinOrLeftRoom) {
      if (data.numUsers === 1) {
        message = 'Artık yalnızsın!';
      } else {
        message = 'Sohbette ' + data.numUsers + ' kullanıcı var';
      }
    }
    log(message);
  }
  ...
  function inputCommand (message) {
    ...
    switch (cmd) {
      ...
      default:
        message = 'Geçersiz bir komut girdiniz';
        log(message);
        break;
    }
  }
